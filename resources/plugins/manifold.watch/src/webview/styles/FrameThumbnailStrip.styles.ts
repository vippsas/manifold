// resources/plugins/manifold.watch/src/webview/styles/FrameThumbnailStrip.styles.ts
// Ported verbatim from src/renderer/components/watch/FrameThumbnailStrip.styles.ts.
