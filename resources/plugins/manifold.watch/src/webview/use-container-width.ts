/// <reference lib="dom" />
// resources/plugins/manifold.watch/src/webview/use-container-width.ts
// Ported verbatim from src/renderer/hooks/useContainerWidth.ts (the webview
// bundle cannot import app src/).
