...
import theme_active4d from './data/Active4D.json'
...
import theme_chrome_devtools from './data/Chrome DevTools.json'
import theme_clouds_midnight from './data/Clouds Midnight.json'
import theme_clouds from './data/Clouds.json'
import theme_cobalt from './data/Cobalt.json'
import theme_cobalt2 from './data/Cobalt2.json'
import theme_dawn from './data/Dawn.json'
import theme_dracula from './data/Dracula.json'
import theme_dreamweaver from './data/Dreamweaver.json'
import theme_eiffel from './data/Eiffel.json'
...
import theme_github from './data/GitHub.json'
import theme_idle from './data/IDLE.json'
import theme_katzenmilch from './data/Katzenmilch.json'
import theme_kuroir_theme from './data/Kuroir Theme.json'
import theme_lazy from './data/LAZY.json'
import theme_magicwb__amiga_ from './data/MagicWB (Amiga).json'
...
import theme_slush_and_poppies from './data/Slush and Poppies.json'
...
import theme_textmate__mac_classic_ from './data/Textmate (Mac Classic).json'
...
import theme_xcode_default from './data/Xcode_default.json'
...
export const themeDataByLabel: Record<string, unknown> = {
  ...
  "Chrome DevTools": theme_chrome_devtools,
  ...
  "Kuroir Theme": theme_kuroir_theme,
  "LAZY": theme_lazy,
  ...
  "Slush and Poppies": theme_slush_and_poppies,
  ...
  "Textmate (Mac Classic)": theme_textmate__mac_classic_,
  ...
  "Xcode_default": theme_xcode_default,
  "Zenburnesque": theme_zenburnesque,
  "iPlastic": theme_iplastic,
