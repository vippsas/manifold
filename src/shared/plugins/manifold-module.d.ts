...
declare module 'manifold' {
  import type { ManifoldApi, ManifoldContext, Disposable, ProjectInfo, SessionInfo, WebviewView, WebviewViewProvider } from './api-types'

  // Re-export named types so `import type { ManifoldContext } from 'manifold'` resolves.
  export type { ManifoldApi, ManifoldContext, Disposable, ProjectInfo, SessionInfo, WebviewView, WebviewViewProvider }
