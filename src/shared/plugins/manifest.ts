...
export const CAPABILITIES = ['storage', 'workspace:read', 'workspace:manage', 'configuration', 'agent:control', 'agent:spawn', 'lm', 'transcription:read', 'verdicts:read'] as const
...
export const BUILTIN_ONLY_CAPABILITIES = ['workspace:manage', 'agent:control', 'agent:spawn', 'lm', 'transcription:read', 'verdicts:read'] as const satisfies readonly Capability[]
