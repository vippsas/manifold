...
/** The search body — field, scope chips and results — filling whatever container
 *  it is mounted in: the search modal's panel or a sidebar column. */
export function SearchView({
  ...
  // Apply the requested scope once per mount; later chip clicks must stick.
  useEffect(() => {
