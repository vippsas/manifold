...
import { loopPanelStyles as S } from './LoopPanel.styles'
import { type FormState, configFromForm, formFromConfig } from './LoopPanel.helpers'
...
export function LoopConfigForm({ sessionId, initialConfig, disabled, onStart, onSave }: ConfigFormProps): React.JSX.Element {
