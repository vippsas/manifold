...
export const LANGUAGE_BY_FILE_NAME_PATTERN: readonly (readonly [pattern: string, languageId: string])[] = [
  ["**/.claude/rules/**/*.md", "instructions"],
  ["**/.github/hooks/*.json", "jsonc"],
  ["**/.github/agents/*.md", "chatagent"],
  ["**/.claude/agents/*.md", "chatagent"],
  ["**/.config/git/config", "properties"],
