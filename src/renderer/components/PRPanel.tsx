...
export function PRPanel({
  ...
  useEffect(() => {
    if (autoGenerateMessages && context && !hasAutoGenerated.current) {
      hasAutoGenerated.current = true
      void generateTitleAndDescription(context)
    }
  }, [autoGenerateMessages, context, generateTitleAndDescription])
