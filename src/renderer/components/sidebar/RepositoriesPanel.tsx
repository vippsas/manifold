...
/**
 * The repositories/sessions surface: favorites, workspaces, repos, their agent
 * sessions and drafts, plus the New Agent / New Repository actions. Extracted
 * from the old sidebar "Repositories" view so it can live in the title-bar
 * repository switcher dropdown (the sidebar now only hosts Explorer + Source
 * Control). Props-based so it stays testable in isolation; the dropdown maps
 * DockStateContext onto these props.
 */
export function RepositoriesPanel({
  ...
  onSelectDraft,
  onDiscardDraft,
}: RepositoriesPanelProps): React.JSX.Element {
  ...
  return (
    <div style={sidebarStyles.repositories}>
      <FavoritesList />
