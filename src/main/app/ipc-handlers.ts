...
export function registerIpcHandlers(deps: IpcDependencies): void {
  ...
  ipcMain.handle('release-notes:get', (_event, version?: string) => {
    return getReleaseNotes(version)
  })

  ipcMain.handle('release-notes:open-external', (_event, version?: string) => {
    return openReleaseNotesExternal(version)
  })
}
