...
**Goal:** Create a Claude Code skill at `~/.claude/skills/orchestrate/SKILL.md` that takes a spec file path and autonomously runs a 7-phase build pipeline: plan, implement, test, refactor, best-practices check, Chrome UI testing, and security fix.

**Architecture:** Single monolithic skill file using YAML frontmatter + markdown. The skill instructs Claude to run 3 sequential stages with parallel subagent fan-out in Stage 2. It uses TaskCreate/TaskUpdate for progress tracking and the Task tool to spawn subagents.

**Tech Stack:** Claude Code skills system (YAML frontmatter + markdown), Claude Code tools (Task, TaskCreate, Bash, Read, Write, Edit, Glob, Grep, Chrome MCP tools)
...
**Files:**
- Create: `~/.claude/skills/orchestrate/` (directory)
...
**Step 1: Write the frontmatter, overview, and argument docs**
...
Expected: Shows the `---` delimiters and `name: orchestrate`.

---

### Task 3: Write Phase 1 — Plan from spec
...
Append to the SKILL.md file after the pipeline diagram:
...
### Task 4: Write Phase 2 — Implement
...
### Task 5: Write Phase 3 — Write tests
...
### Task 6: Write Phase 4 — Refactor

**Files:**
- Modify: `~/.claude/skills/orchestrate/SKILL.md`

**Step 1: Append Phase 4 instructions**
...
### Task 7: Write Phase 5 — Best practices check

**Files:**
- Modify: `~/.claude/skills/orchestrate/SKILL.md`

**Step 1: Append Phase 5 instructions**
...
### Task 8: Write Phase 6 — Chrome UI testing

**Files:**
- Modify: `~/.claude/skills/orchestrate/SKILL.md`

**Step 1: Append Phase 6 instructions**
...
### Task 9: Write Phase 7 — Security fix

**Files:**
- Modify: `~/.claude/skills/orchestrate/SKILL.md`

**Step 1: Append Phase 7 instructions**
...
### Task 10: Write the execution orchestration and summary sections

**Files:**
- Modify: `~/.claude/skills/orchestrate/SKILL.md`

**Step 1: Append the orchestration instructions and summary template**
...
### Task 11: Verify the complete skill file
...
Expected: File exists with all sections (frontmatter, overview, 7 phases, execution, summary, common mistakes).

**Step 2: Verify frontmatter is valid**

```bash
head -4 ~/.claude/skills/orchestrate/SKILL.md
```

Expected: `---`, `name: orchestrate`, `description: ...`, `---`

**Step 3: Verify all 7 phases are present**

Search for all phase headers:

```bash
grep "^## Phase" ~/.claude/skills/orchestrate/SKILL.md
```
