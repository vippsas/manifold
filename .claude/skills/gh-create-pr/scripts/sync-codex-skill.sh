...
sed -i.bak 's|bash \.claude/skills/gh-create-pr/scripts/sync-codex-skill\.sh|bash ~/.codex/skills/gh-create-pr/scripts/sync-codex-skill.sh|g' "$target_dir/SKILL.md"
rm -f "$target_dir/SKILL.md.bak"

chmod +x "$target_dir/scripts/sync-codex-skill.sh"
